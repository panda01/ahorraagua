	...
	<ul class="oss-social-share clr">
		...
		foreach ( $sites as $site ) :
			...
			if ( 'twitter' == $site ) {
				...
				<li class="twitter">
					<a href="https://twitter.com/share?text=<?php echo html_entity_decode( wp_strip_all_tags( $title ) ); ?>&amp;url=<?php echo rawurlencode( esc_url( $url ) ); ?><?php if ( $handle ) echo '&amp;via='. esc_attr( $handle ); ?>" title="<?php esc_html_e( 'Share on Twitter', 'ocean-social-sharing' ); ?>" onclick="oss_onClick( this.href );return false;">
			...
			if ( 'linkedin' == $site ) { ?>
				...
				<li class="linkedin">
					<a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo rawurlencode( esc_url( $url ) ); ?>&amp;title=<?php echo html_entity_decode( wp_strip_all_tags( $title ) ); ?>&amp;summary=<?php echo wp_trim_words( strip_shortcodes( get_the_content( $post_id ) ), 40 ); ?>&amp;source=<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php esc_html_e( 'Share on LinkedIn', 'ocean-social-sharing' ); ?>" onclick="oss_onClick( this.href );return false;">
						<span class="oss-icon-wrap">
			...
			if ( 'reddit' == $site ) { ?>
				...
				<li class="reddit">
					<a href="http://www.reddit.com/submit?url=<?php echo rawurlencode( esc_url( $url ) ); ?>&amp;title=<?php echo html_entity_decode( wp_strip_all_tags( $title ) ); ?>" title="<?php esc_html_e( 'Share on Reddit', 'ocean-social-sharing' ); ?>" onclick="oss_onClick( this.href );return false;">
						<span class="oss-icon-wrap">
