...
class Jetpack_Lazy_Images {
	...
	private function __construct() {
		...
		add_action( 'wp_head', array( $this, 'setup_filters' ), 9999 ); // we don't really want to modify anything in <head><script type=text/javascript> </script> since it's mostly all metadata
