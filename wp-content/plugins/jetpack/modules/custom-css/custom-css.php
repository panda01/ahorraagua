...
class Jetpack_Custom_CSS {
	...
	static function print_css() {
		...
		/**
		 * Fires right before printing the custom CSS inside the <head><script type=text/javascript> </script> element.
		 *
		 * @module custom-css
		 *
		 * @since 1.7.0
	...
	static function link_tag() {
		...
		/**
		 * Fires after creating the <link> in the <head><script type=text/javascript> </script> element for the custom css stylesheet.
		 *
		 * @module custom-css
		 *
		 * @since 2.2.2
