...
<p class="jetpack-simple-payments-products-fieldset" <?php if ( empty( $product_posts ) ) { echo 'style="display:none;"'; } ?>>
	<label for="<?php echo $this->get_field_id('product_post_id'); ?>"><?php esc_html_e( 'Select a Simple Payment Button:', 'jetpack' ); ?></label>
	<select
...
<p class="jetpack-simple-payments-products-warning" <?php if ( ! empty( $product_posts ) ) { echo 'style="display:none;"'; } ?>>
	<?php esc_html_e( 'Looks like you don\'t have any products. You can create one using the Add New button below.' ) ?>
</p>
<p>
	<div class="alignleft">
...
<div class="jetpack-simple-payments-form" style="display: none;">
	...
	<p>
		...
		<br />
		<small><?php esc_html_e( 'For example: event tickets, charitable donations, training courses, coaching fees, etc.' ); ?></small>
	</p>
	...
	<p>
		<div class="alignleft">
			<button type="button" class="button-link button-link-delete jetpack-simple-payments-delete-product"><?php esc_html_e( 'Delete Product' ); ?></button>
		</div>
		<div class="alignright">
			<button name="<?php echo $this->get_field_name('save'); ?>" class="button jetpack-simple-payments-save-product"><?php esc_html_e( 'Save' ); ?></button>
			<span> | <button type="button" class="button-link jetpack-simple-payments-cancel-form"><?php esc_html_e( 'Cancel' ); ?></button></span>
		</div>
		<br class="clear">
	</p>
	<hr />
